...
import com.zjy.esdemo.dao.TestDao;
...
public class TestServiceImpl implements TestService {
    ...
    public List<TestPo> findAll() {
        Iterable<TestPo> all = testDao.findAll();
    ...
    public void createIndex() {
        elasticsearchTemplate.createIndex(TestPo.class);
    }
    ...
    public void saveTest() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            TestPo testBean = new TestPo(i, names[i1], String.valueOf(i % 2), descArr[i2]);
    ...
    @Override
    public List<TestPo> findByName(String text) {
