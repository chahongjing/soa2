...
//@Slf4j
@Component
public class ShardingTableModuloAlgorithm implements StandardShardingAlgorithm<Long> {
    ...
    public String doSharding(Collection<String> collection, PreciseShardingValue<Long> preciseShardingValue) {
        ...
        return String.format("%s_%d", logicTableName, busCode % 4);
    }
    ...
    public String getType() {
        return "SHARD_TABLE"; //算法名称，可以自己定义。注意yaml中要用这个名字
    }
}
